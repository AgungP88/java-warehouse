 ...
 * @author hp
 */
public class app_utama_karyawan extends javax.swing.JFrame {

    /**
     * Creates new form app_utama
     */
    public app_utama_karyawan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        menuMasterPelanggan.setEnabled(false);
        ...
        menuMasterPemasok.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(app_utama_karyawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new app_utama_karyawan().setVisible(true);
            }
        });
    }
